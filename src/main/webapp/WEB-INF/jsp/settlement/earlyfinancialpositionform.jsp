   ...
   function currencyFormatter(params) {
    ...
    var gridOptions;
      function createFinancialPositionGrid() {
        rowData=[];
        var columnDefs = [
             {headerName: "계층", field: "lev",width:150, hide: true },
             {headerName: "분류", field: "category",width:150},
             {headerName: "계정과목", field: "accountName",width:150 , cellStyle : {"textAlign":"left" ,"whiteSpace":"pre"} },
           {
           headerName: '회계기수',
           headerClass: 'participant-group',
           marryChildren: true,
           children: [
             { headerName:'세부금액', field: 'balanceDetail', colId: '당기' , width:150,valueFormatter:currencyFormatter },
             { headerName:'합계금액', field: 'balanceSummary', colId: '당기' , width:150, valueFormatter:currencyFormatter },
           ]
           }/*,
           {
            headerName: '전기',
            ...
            marryChildren: true,
            children: [
            { headerName:'세부금액', field: 'preBalanceDetail', colId: '전기' , width:150, valueFormatter:currencyFormatter},
            { headerName:'합계금액', field: 'preBalanceSummary', colId: '전기' , width:150, valueFormatter:currencyFormatter},
            ]
          },*/
        ];        
        gridOptions = {
        ...
        financialPositionGrid = document.querySelector('#financialPositionGrid');
         new agGrid.Grid(financialPositionGrid,gridOptions);
    }
      
      function createPdf() {
          window.open("${pageContext.request.contextPath}/base/financialpositionpdf");   
    }
   ...
   function showFinancialPosition(){
	   $.ajax({
           ...
           success: function (jsonObj) {
           	...
           	console.log(jsonObj.accountingSettlementStatus[0].totalTrialBalance);
    ...
    function showAccountPeriod(){
       ...
       $.ajax({
              ...
              success: function (jsonObj) {
            	 ...
            	 obj.pop();
                 console.log(obj);
                  gridOptions3.api.setRowData(obj);
...
<body class="bg-gradient-primary">
      ...
      <div align="center">
         <div id="financialPositionGrid" class="ag-theme-balham"  style="height:500px;width:auto;" ></div>
      </div>
